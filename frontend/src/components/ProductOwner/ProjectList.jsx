              ...
              {projects.map((project, projectIndex) => (
                <tr key={project._id} className="shadow-md my-4 rounded-2xl">
                  ...
                  <td className="p-2 ">
                    ...
                    <div className="hidden md:flex">{project.scrumMaster.username}</div>
                    <img src={project.scrumMaster.profileImage} alt="Profile Image" className="h-8 w-8 rounded-full"/>
                    </div>
                  </td>
